                    ...
                    toHTML(Calendar.DAY_TEMPLATE,
                        {
                            ...
                            'status': this._getRoomStatus(date) ? + oData[date].roomNum + '\u95f4' : '',
...
}, 
{
    ...
    CALENDAR_TEMPLATE: '<div id="{bounding_box_id}" class="price-calendar-bounding-box">' +
                            '<div class="container">' +
                                '<div class="content-box">' +
                                    '<div class="arrow">' +
                                        '<span class="prev-btn" title="\u4e0a\u6708">prev</span>' +
                                        '<span class="next-btn" title="\u4e0b\u6708">next</span>' +
                                    '</div>' +                               
                                    '<div class="date-box">' +
                                        '{date_template}' +
                                    '</div>' +
    ...
    DAY_TEMPLATE: '<td data-date="{date}" class="{disabled}{saturday}{dep_date}{end_date}">' +
                        ...
                        '</p>' +
                       '<p class="select">' +
                           '<a href="javascript:;" class="in">\u5f00\u59cb\u65e5\u671f</a>' +
                           '<a href="javascript:;" class="out">\u7ed3\u675f\u65e5\u671f</a>' +
                       '</p>' +                     
                    '</td>',
